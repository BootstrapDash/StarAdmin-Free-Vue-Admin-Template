      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="wrapper d-flex align-items-center py-2 border-bottom">
            <img class="img-sm rounded-circle" src="../../src/assets/images/faces/face5.jpg" alt="profile">
          ...
          <div class="wrapper d-flex align-items-center py-2 border-bottom">
            <img class="img-sm rounded-circle" src="../../src/assets/images/faces/face6.jpg" alt="profile">
            <div class="wrapper ml-3">
          ...
          <div class="wrapper d-flex align-items-center py-2 border-bottom">
            <img class="img-sm rounded-circle" src="../../src/assets/images/faces/face7.jpg" alt="profile">
            <div class="wrapper ml-3">
          ...
          <div class="wrapper d-flex align-items-center py-2 border-bottom">
            <img class="img-sm rounded-circle" src="../../src/assets/images/faces/face8.jpg" alt="profile">
            <div class="wrapper ml-3">
          ...
          <div class="wrapper d-flex align-items-center py-2 mb-4">
            <img class="img-sm rounded-circle" src="../../src/assets/images/faces/face9.jpg" alt="profile">
            <div class="wrapper ml-3">
          ...
          <div class="preview-list">
            <div class="preview-item border-bottom px-0">
              <div class="preview-thumbnail">
                <img src="../../src/assets/images/faces/face6.jpg" alt="image" class="rounded-circle"/>
              </div>
            ...
            <div class="preview-item border-bottom px-0">
              <div class="preview-thumbnail">
                <img src="../../src/assets/images/faces/face8.jpg" alt="image" class="rounded-circle"/>
              </div>
              <div class="preview-item-content d-flex flex-grow">
                <div class="flex-grow">
            ...
            <div class="preview-item border-bottom px-0">
              <div class="preview-thumbnail">
                <img src="../../src/assets/images/faces/face9.jpg" alt="image" class="rounded-circle"/>
              </div>
              <div class="preview-item-content d-flex flex-grow">
                <div class="flex-grow">
            ...
            <div class="preview-item border-bottom px-0">
              <div class="preview-thumbnail">
                <img src="../../src/assets/images/faces/face11.jpg" alt="image" class="rounded-circle"/>
              </div>
              <div class="preview-item-content d-flex flex-grow">
                <div class="flex-grow">
